...
from empath.models.ace_step_transformer import empathTransformer2DModel
...
class empathPipeline:
    ...
    def load_checkpoint(self, checkpoint_dir=None, export_quantized_weights=False):
        ...
        self.ace_step_transformer = empathTransformer2DModel.from_pretrained(
    ...
    def load_quantized_checkpoint(self, checkpoint_dir=None):
        ...
        self.ace_step_transformer = empathTransformer2DModel.from_pretrained(ace_step_checkpoint_path)
